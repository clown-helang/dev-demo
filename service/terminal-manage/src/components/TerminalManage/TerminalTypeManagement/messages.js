...
const messages = defineMessages({
  TerminalTypeManagement:{
    terminal_type_title:{
      id:'common.TerminalTypeManagement.terminal_type_title',
      defaultMessage:'终端型号管理',
    },
    name:{
      id:'common.TerminalTypeManagement.name',
      defaultMessage:'型号名称',
    },
    provider:{
      id:'common.TerminalTypeManagement.provider',
      defaultMessage:'厂商',
    },
    device_type:{
      id:'common.TerminalTypeManagement.device_type',
      defaultMessage:'终端类型',
    },
    create_time:{
      id:'common.TerminalTypeManagement.create_time',
      defaultMessage:'创建时间',
    },
    operation:{
    ...
    type:{
      id:'common.TerminalTypeManagement.type',
      defaultMessage:'型号',
    }
  },
  NotNull:{
    id: 'common.TerminalTypeManagement.NotNull',
    defaultMessage: '不能为空',
  },
  placeholder:{
